...
1. **Per-process marker.** At SessionStart, `proj.<agent_pid>.project` records
   ...
   markers are GC'd at SessionStart/SessionEnd. Available in monitor/both mode
   for Claude Code and Monitor-enabled Codex; runtimes without SessionStart
   hooks rely on signals 2–3.
